...
renderCUDA(
	...
	float* __restrict__ dL_dradius2D,
	...
	float* __restrict__ dL_ddepths)
{
	...
	if (inside) 
	{
		...
		dL_dpixel_depth = dL_dpixel_depths[pix_id]; // get this gradient
		dL_dpixel_alpha = dL_dpixel_alphas[pix_id]; // get this gradient
	}
	float last_alpha = 0;
