...
from jdhr.engine.registry import Registry, call_from_cfg, callable_from_cfg  # will cause circular import if using full path here
from jdhr.engine.config import Config, DictAction, ConfigDict
...
def get_parser():
    parser = argparse.ArgumentParser(prog='evc', description='jdhr Project')
