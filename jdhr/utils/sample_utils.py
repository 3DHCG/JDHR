...
# Utils
from jdhr.utils.console_utils import log
from jdhr.utils.base_utils import dotdict
from jdhr.utils.math_utils import normalize_sum
from jdhr.utils.chunk_utils import linear_gather, multi_gather, multi_gather_tris, batch_aware_indexing, multi_scatter, multi_scatter_
...
def sample_texture(uvs: jt.Var, textures: jt.Var, from_ndc: bool = False, flip_tex: bool = True) -> jt.Var:
    ...
    from jdhr.utils.grid_utils import grid_sample
