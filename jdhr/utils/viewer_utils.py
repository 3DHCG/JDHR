...
from jdhr.utils.easy_utils import read_camera, write_camera
from jdhr.utils.math_utils import normalize, affine_inverse
from jdhr.utils.data_utils import to_numpy, to_tensor, to_cuda, to_list
from jdhr.utils.cam_utils import gen_cubic_spline_interp_func, gen_linear_interp_func
...
def add_debug_line(proj: mat4, a: vec3, b: vec3, col: np.uint32 = 0xffffffff, thickness: float = 2.0):
    ...
    # b: 3,
    from imgui_bundle import imgui
    from jdhr.utils.imgui_utils import col2imu32
...
class CameraPath:
    ...
    def render_imgui(self, viewer: 'VolumetricVideoViewer', batch: dotdict):
        # from jdhr.utils.gl_utils import Mesh
        # Mesh.render_imgui(self, viewer, batch)
        from imgui_bundle import imgui
        from jdhr.utils.imgui_utils import push_button_color, pop_button_color, col2rgba, col2vec4, vec42col, list2col, col2imu32
