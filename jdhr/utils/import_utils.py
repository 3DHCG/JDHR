...
def discover_modules():
    ...
    # from jdhr import * # recursively import all modules
    __import__('jdhr', fromlist=['*'])  # FIXME: the registry system is inherantly flawed, maybe use full paths?
    # from jdhr.utils.console_utils import *

    # from jdhr.utils.console_utils import log
    # from jdhr.engine.registry import Registry
    ...
    # log('Registered jdhr modules: ', registries)
